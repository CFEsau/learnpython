...
# Define a function called print_all to print the whole contents
# of a file, with one file object as a formal parameter
def print_all(f):
...
# with an integer counter and a file object as formal parameters
def print_a_line(line_count, f):
    ...
    # The comma at the end removes the \n character that is
    # at the end of the lines that are read in.
